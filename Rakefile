...
task "browscap:dump" do
  require File.join(File.dirname(__FILE__), %w{ lib browscap })
  ...
  Browscap.load(ENV['IN'])
  File.open(ENV['OUT'], 'wb') do |fp|
    fp.write(Marshal.dump(Browscap.entries))
  end
end